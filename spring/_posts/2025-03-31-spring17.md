...
public enum BoardErrorCode implements ErrorCode{
    POSTS_NOT_FOUND(400, "ERR_POSTS_NOT_FOUND", "게시글을 찾을 수 없습니다."),
    // 발생한 에러는 하단의 BoardErrorCode.CATEGORY_NOT_FOUND 
    CATEGORY_NOT_FOUND(400, "ERR_CATEGORY_NOT_FOUND", "카테고리를 찾을 수 없습니다."),
    TITLE_REQUIRED(400, "ERR_TITLE_REQUIRED", "제목을 작성해주세요."),
    CONTENT_REQUIRED(400, "ERR_CONTENT_REQUIRED", "내용을 작성해주세요.")
    ;
